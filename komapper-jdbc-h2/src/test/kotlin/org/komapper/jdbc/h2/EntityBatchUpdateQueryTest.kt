...
class EntityBatchUpdateQueryTest(private val db: Database) {
    ...
    fun test() {
        ...
        val results = db.batchUpdate(a, updateList)
        val after = db.execute(EntityQuery.from(a).where { a.addressId inList listOf(16, 17, 18) })
    ...
    fun updatedAt() {
        ...
        val results = db.batchUpdate(p, personList)
