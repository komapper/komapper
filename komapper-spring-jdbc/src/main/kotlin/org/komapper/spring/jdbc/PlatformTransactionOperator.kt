...
class PlatformTransactionOperator(private val transactionManager: PlatformTransactionManager) : JdbcTransactionOperator {

    override fun <R> required(transactionDefinition: JdbcTransactionDefinition?, block: (JdbcTransactionOperator) -> R): R {
    ...
    override fun <R> requiresNew(transactionDefinition: JdbcTransactionDefinition?, block: (JdbcTransactionOperator) -> R): R {
