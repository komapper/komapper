...
sealed class Criterion {
    ...
    data class Like(val left: Operand, val right: Operand.Escape) : Criterion()
    data class NotLike(val left: Operand, val right: Operand.Escape) : Criterion()
    ...
    data class InSubQuery(val left: Operand, val right: Operand.Subquery) : Criterion()
    data class NotInSubQuery(val left: Operand, val right: Operand.Subquery) : Criterion()
    ...
    data class InSubQuery2(val left: Pair<Operand, Operand>, val right: Operand.Subquery) : Criterion()
    data class NotInSubQuery2(val left: Pair<Operand, Operand>, val right: Operand.Subquery) : Criterion()
    data class Exists(val operand: Operand.Subquery) : Criterion()
    data class NotExists(val operand: Operand.Subquery) : Criterion()
