...
interface QueryVisitor {
    ...
    fun <LEFT, RIGHT> visit(query: Query.Plus<LEFT, RIGHT>): QueryRunner

    fun <LEFT, RIGHT> visit(query: Query.FlatMap<LEFT, RIGHT>): QueryRunner

    fun <LEFT, RIGHT> visit(query: Query.FlatZip<LEFT, RIGHT>): QueryRunner
