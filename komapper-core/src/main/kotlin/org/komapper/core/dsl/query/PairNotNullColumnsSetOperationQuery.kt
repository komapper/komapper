...
internal data class PairNotNullColumnsSetOperationQuery<A : Any, B : Any>(
    ...
    override fun <VISIT_RESULT> accept(visitor: QueryVisitor<VISIT_RESULT>): VISIT_RESULT {
        return visitor.pairNotNullColumnsSetOperationQuery(context, expressions) { it.toList() }
    }

    override fun <VISIT_RESULT> accept(visitor: FlowQueryVisitor<VISIT_RESULT>): VISIT_RESULT {
        return visitor.pairNotNullColumnsSetOperationQuery(context, expressions)
    }

    override fun <R> collect(collect: suspend (Flow<Pair<A, B>>) -> R): Query<R> = object : Query<R> {
        override fun <VISIT_RESULT> accept(visitor: QueryVisitor<VISIT_RESULT>): VISIT_RESULT {
            return visitor.pairNotNullColumnsSetOperationQuery(context, expressions, collect)
        }
    }
