...
class SqlTokenizerTest {
    ...
    fun testColumnNumber() {
        ...
        assertEquals(0, tokenizer.location.endColumnIndex)
        assertEquals(WORD, tokenizer.next())
        assertEquals("aaa", tokenizer.token)
        assertEquals(3, tokenizer.location.endColumnIndex)
        assertEquals(SPACE, tokenizer.next())
        assertEquals(" ", tokenizer.token)
        assertEquals(4, tokenizer.location.endColumnIndex)
        assertEquals(WORD, tokenizer.next())
        assertEquals("bbb", tokenizer.token)
        assertEquals(7, tokenizer.location.endColumnIndex)
        assertEquals(EOL, tokenizer.next())
        assertEquals("\n", tokenizer.token)
        assertEquals(8, tokenizer.location.endColumnIndex)
        assertEquals(WORD, tokenizer.next())
        assertEquals("c", tokenizer.token)
        assertEquals(1, tokenizer.location.endColumnIndex)
        assertEquals(EOL, tokenizer.next())
        assertEquals("\n", tokenizer.token)
        assertEquals(2, tokenizer.location.endColumnIndex)
        assertEquals(WORD, tokenizer.next())
        ...
        assertEquals(5, tokenizer.location.endColumnIndex)
        assertEquals(EOL, tokenizer.next())
        assertEquals("\n", tokenizer.token)
        assertEquals(6, tokenizer.location.endColumnIndex)
        assertEquals(EOF, tokenizer.next())
        assertEquals("", tokenizer.token)
    }
