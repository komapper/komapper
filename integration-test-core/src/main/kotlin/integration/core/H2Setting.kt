...
interface H2Setting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        ...
        create table if not exists any_data(id integer not null primary key, "value" other);
        create table if not exists array_data(id integer not null primary key, "value" varchar(10) array);
        ...
        create table if not exists boolean_data(id integer not null primary key, "value" bool);
        create table if not exists byte_data(id integer not null primary key, "value" tinyint);
        create table if not exists byte_array_data(id integer not null primary key, "value" binary(3));
        create table if not exists clob_data(id integer not null primary key, "value" clob);
        ...
        create table if not exists sqlxml_data(id integer not null primary key, "value" clob);
