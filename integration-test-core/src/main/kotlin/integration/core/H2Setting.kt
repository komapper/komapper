...
public interface H2Setting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        get() =
            ...
            create table if not exists identity_strategy(id integer not null generated by default as identity primary key, "value" varchar(10));
            create table if not exists sequence_strategy(id integer not null primary key, "value" varchar(10));
            create table if not exists insert_test(id integer not null generated by default as identity primary key, name varchar(20) not null, created_by varchar(20) default 'system', version integer);
            ...
            create table if not exists multi_generated(created_at timestamp with time zone default now(), id integer not null generated by default as identity primary key);
