...
public interface PostgreSqlSetting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        get() =
            ...
            create table if not exists student (student_id int primary key, student_name varchar(50));
            create table if not exists course (course_id int primary key, course_name varchar(50), student_id int);
