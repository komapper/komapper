...
public interface SqlServerSetting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        get() =
            ...
            create table blob_data(id int not null primary key, value varbinary(max));
            create table boolean_data(id int not null primary key, value bit);
            create table byte_data(id int not null primary key, value tinyint);
            create table byte_array_data(id int not null primary key, value varbinary(100));
            create table clob_data(id int not null primary key, value text);
            ...
            create table local_date_time_data(id int not null primary key, value datetime2);
            create table local_date_data(id int not null primary key, value date);
            create table local_time_data(id int not null primary key, value time);
            create table long_data(id int not null primary key, value bigint);
