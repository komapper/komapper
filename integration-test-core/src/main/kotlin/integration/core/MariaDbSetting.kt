...
public interface MariaDbSetting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        get() =
            ...
            create table if not exists human(human_id integer not null primary key, name varchar(20), created_at timestamp(6), updated_at timestamp(6), version integer, created_by varchar(20), updated_by varchar(20));
