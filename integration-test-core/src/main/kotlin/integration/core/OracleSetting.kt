...
public interface OracleSetting<DATABASE : Database> : Setting<DATABASE> {
    ...
    override val createSql: String
        get() =
            ...
            create table blob_data(id integer not null primary key, "value" blob);
            create table boolean_data(id integer not null primary key, "value" number(1, 0));
            create table byte_data(id integer not null primary key, "value" integer);
            create table byte_array_data(id integer not null primary key, "value" raw(1000));
            create table clob_data(id integer not null primary key, "value" clob);
            create table double_data(id integer not null primary key, "value" float);
            ...
            create table local_date_time_data(id integer not null primary key, "value" date);
            create table local_date_data(id integer not null primary key, "value" date);
            create table local_time_data(id integer not null primary key, "value" timestamp);
            create table long_data(id integer not null primary key, "value" integer);
            create table offset_date_time_data(id integer not null primary key, "value" timestamp with time zone);
            ...
            create table student (student_id number primary key, student_name varchar2(50));
            create table course (course_id number primary key, course_name varchar2(50), student_id number);
